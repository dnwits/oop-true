 ...
 * @author ves8167
 */
public class E4_article {
    private String nombre;
    private double precio;
    private int iva;
    private int cuantosQuedan;
    private static final int iva_gen = 21;
    private static final int iva_redu = 10;
    private static final int iva_supRedu = 4;

    public E4_article(String nombre, double precio, int iva, int cuantosQuedan) {
        if (nombre.equals("")) {
    ...
    public void setIva(int iva) {
        if (iva != E4_article.iva_gen && iva != E4_article.iva_redu && iva != E4_article.iva_supRedu) {
